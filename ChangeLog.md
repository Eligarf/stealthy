...
- dnd5e: _Hiding_ Status Effect can be used to bank stealth results (Foundry v12/dnd5e v3.2 only)
...
- PF2e: Abandonded Stealthy for PF2e. Use [PF2e Avoid Notice](https://foundryvtt.com/packages/pf2e-avoid-notice) and _Pf2e Perception_ instead.
